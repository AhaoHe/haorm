...
class Wrapper {
    ...
    select(params){
        ...
        if( type == 'object')
           columns = this.generator.columns(params)
        else if(type == 'string')
            columns = params;
        else
    ...
    update(params){
        ...
        let updateStr = this.generator.update(this.tablename,this.struct,params);
        this.sqlStr.push()
        return this
    }
    ...
    notIn(key,value){
        this.sqlStr.push(this.generator.condition_symbol(this.struct,key,'notin',value));
        return this;
    }
